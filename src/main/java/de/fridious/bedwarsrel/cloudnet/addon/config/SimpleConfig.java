...
/*
 *
 *  * Copyright (c) 2018 Philipp Elvin Friedhoff on 04.12.18 14:46
 *
 */
...
public abstract class SimpleConfig {
    ...
    public SimpleConfig(File file) {
        ...
        try{
            ...
            System.out.println(BedwarsRelCloudNetAddon.getInstance().getPluginConfig().getConsolePrefix() + "Could not create config file.");
